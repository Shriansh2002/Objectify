		...
		>
			...
			<div className="px-6 py-4">
				<button
					target="_blank"
					rel="noreferrer"
					className="w-full relative inline-flex items-center justify-center py-2 px-4 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded shadow-xl group"
					onClick={() => handleSampleImageChange(_idx)}
				>
					<span className="absolute inset-0 w-full h-full bg-gradient-to-br from-orange-600 via-yellow-600 to-orange-600"></span>
